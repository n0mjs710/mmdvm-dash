...
🎛️ **Multi-Mode Support**: DMR, D-Star, YSF, P25, NXDN, FM  
...
📊 **Configuration-Aware**: Reads MMDVM.ini and gateway configs to understand expected state  
📜 **Log History**: Scans previous days' logs when needed to establish baseline state  
🎨 **Mode-Based Color Coding**: Visual distinction for DMR, D-Star, YSF, P25, NXDN, FM  
📋 **Live Log Tailing**: Rolling window showing recent log entries with minimal processing  
💡 **Status Cards**: Mode and network status cards with color-coded indicators  
